...
const Login = () => {
    ...
    //Google Login handler from Own login Component
...
<div className=" bg-gray-100 text-gray-900 flex justify-center">
    <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
        ...
        {/* Login title ends */}
            ...
            <div className="mt-12 flex flex-col items-center">
                ...
                <div className="w-full flex-1 mt-8">
                   ...
                   {error && (
                        <div
                          class="bg-orange-100 border-l-4 border-orange-500 text-orange-700 p-4 mb-5 mt-5"
                          role="alert"
                        >
                          <p>{error}.</p>
                        </div>
        ...
        <div className="flex-1 bg-indigo-100 text-center hidden lg:flex">
            <div className=" m-2 w-full bg-contain bg-center bg-no-repeat items-center flex justify-center "
                >
                    <img 
                    className='rounded-2xl h-3/5'
                    src="https://img.freepik.com/free-psd/3d-male-cartoon-character-standing-padlock-holding-key_1150-56172.jpg?t=st=1733748539~exp=1733752139~hmac=62e0e1f300076074c1b92d6effea06cadceb8299d51ad5e471b5a6c61c42e283&w=996" alt="" />
            </div>
        </div>
    </div>
</div>
