            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              <div className="text-center mb-10">
                ...
                <button
                  ...
                  className="mb-5 mx-auto w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline"
                >
              ...
              <div>
                ...
                <form onSubmit={handleSubmit} action="">
                  ...
                  <div className="flex -mx-3">
                   ...
                   {error && (
                        <div
                          class="bg-orange-100 border-l-4 border-orange-500 text-orange-700 p-4 mb-5 -mt-7"
                          role="alert"
                        >
                          <p>{error}.</p>
                        </div>
